...
def read_secret(key, default=None):
    try:
        return Path(os.environ[key]).read_text(encoding='utf-8').strip()
...
SECRET_KEY = read_secret(
    'DJANGO_SECRET_FILE',
    'django-insecure-%84orwgtlp8x67n6^b444p5q-m6a$uf-zkopk58nt+fx$l=okr'
)

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DJANGO_DEBUG', 'false').strip().lower() \
    in ['t', 'true', 'y', 'yes', '1']
...
DATABASES = {
    'default': {
        ...
        'HOST': read_secret('POSTGRES_HOSTNAME_FILE'),
...
if sentry_key := read_secret('SENTRY_KEY_FILE'):
    import sentry_sdk
